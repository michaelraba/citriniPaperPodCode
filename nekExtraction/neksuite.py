...
def writenek_multi(fname, data,nel_tot,fid,nf):                                                                                                               
	"""                                                                                                                              
	    writenek                                                                                                                     
	    A function for writing binary data in the nek5000 binary format                                                              
	...
	# generate header                                                                                                                
	header = '#std %1i %2i %2i %2i %10i %10i %20.13E %9i %6i %6i %s\n' %(                                                            
		data.wdsz, data.lr1[0], data.lr1[1], data.lr1[2], nelf, nel_tot,                                                        
		data.time, data.istep, fid, nf, vars)                                                                                    
	#                                                                                                                                
	# write header                                                                                                                   
	header = header.ljust(132)                                                                                                       
	...
	# generate and write element map for the file                                                                                    
	elmap = range(data.nel+1)[1:]                                                                                                    
	elmapnew = range(fid*data.nel+data.nel+1)[fid*data.nel+1:]                                                                                                    
	outfile.write(struct.pack(emode+nelf*'i', *elmapnew))                                                                               
	#                                                                                                                                
	#---------------------------------------------------------------------------                                                     
	# WRITE DATA                                                                                                                     
	#---------------------------------------------------------------------------                                                     
